...
export class UserResolver {
    ...
    @OptionalAccessToken()
    async getPostFromUser(@Ctx() ctx: ContextAuthCustom<Map<string, PostModel>> | ContextCustom<Map<string, PostModel>>, @Arg("nickname", () => String) nickname: string): Promise<PostType[] | null> {
