...
const Navbar = () => {
    return (
        <div className="font-main rounded-r-lg text-white p-2 flex flex-col items-center justify-around bg-black fixed top-0 left-0 h-screen w-[5%]">
            <Link href="/home" className="w-full relative flex flex-row justify-center items-center gap-4 cursor-pointer p-3 hover:bg-white hover:text-black transition rounded-full">
